 ...
 *          ERROR
 * */ 
OPERATE_RET tkl_ble_mesh_node_devkey_add(USHORT_T device_addr, uint8_t devkey[16]);
 ...
 *          ERROR
 * */ 
OPERATE_RET tkl_ble_mesh_node_devkey_delete(USHORT_T device_addr, uint8_t devkey[16]);
