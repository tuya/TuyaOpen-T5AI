...
boot_slots_compatible(struct boot_loader_state *state)
{
    ...
    while (i < num_sectors_primary || j < num_sectors_secondary) {
        if (sz0 == sz1) {
             ...
             */
            if (smaller == 2) {
                BOOT_LOG_WRN("Cannot upgrade: slots have non-compatible sectors 1");
                return 0;
            }
            smaller = 1;
            i++;
             ...
             */
            if (smaller == 1) {
                BOOT_LOG_WRN("Cannot upgrade: slots have non-compatible sectors 2");
                return 0;
            }
            smaller = 2;
            j++;
...
int app_max_size(struct boot_loader_state *state)
{
    ...
    while (i < num_sectors_primary || j < num_sectors_secondary) {
        if (sz0 == sz1) {
             ...
             */
            if (smaller == 2) {
                BOOT_LOG_WRN("Cannot upgrade: slots have non-compatible sectors 3");
                return 0;
            }
            smaller = 1;
            i++;
             ...
             */
            if (smaller == 1) {
                BOOT_LOG_WRN("Cannot upgrade: slots have non-compatible sectors 4");
                return 0;
            }
            smaller = 2;
            j++;
