...
#define CONFIG_BL2_B_VIRTUAL_CODE_START (FLASH_PHY2VIRTUAL(CEIL_ALIGN_34(CONFIG_OTA_PHY_PARTITION_OFFSET)))
#endif
...
#define BL2_DATA_SIZE     KB(256)
#define BL2_IRAM_START    (BL2_DATA_START + BL2_DATA_SIZE + 32)
#define BL2_IRAM_SIZE     KB(64)
